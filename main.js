...
quick_draw_data_set=(random_no);
document.getElementById("sktch_to_be_drwn").innerHTML=random_no;
var timer_counter=0;
var timer_check="";
var drawn_sketch="";
var answer_holder="";
...
function updateCanvas(){
    background("white");
    Math.floor(quick_draw_data_set,random_no);
    console.log(quick_draw_data_set);
    document.getElementById("sketch").innerHTML=sktch_to_be_drwn;
}
function setup(){
...
function draw(){
    check_sketch();
    if(drawn_sketch==sktch_to_be_drwn){
        answer_holder=set;
        score=score+1;
